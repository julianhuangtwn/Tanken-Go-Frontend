...
export default function Page() {
    ...
    return (
        <div style={{flex: 1, display: 'flex', flexDirection: 'row', maxHeight:"80vh"}}>
        <div className="h-screen p-4" style={{border: "1px solid black", width: "50%"}}>
            <div className="flex flex-col h-full max-h-full rounded-lg bg-themePink" style={{width: "100%", maxHeight: "75vh"}}>
